...
Ao refinar, preferir o menor escopo que entregue valor real, evitando pedir soluções caras ou complexas sem necessidade de negócio.
...
Exemplos de atores genéricos: usuário final, administrador, operador, cliente, atendente, gestor, sistema integrado. Adapte ao domínio real do projeto.
...
* Não pedir tecnologia nova ou cara se a solução simples resolver
